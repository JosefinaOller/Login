...
public class Modificacion extends javax.swing.JFrame {
    ...
    public Modificacion(Controladora control, int id_usuario) {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        usuario = control.traerUsuario(id_usuario);
        ...
        for (int i = 0; i < cmbRol.getItemCount(); i++) {
            if (String.valueOf(cmbRol.getItemAt(i)).equals(rol)) { //Ponemos String porque sino nos devuelve objeto y sería false siempre
